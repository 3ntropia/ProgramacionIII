...
public class Strasser {
	public static MatrizTDA<Integer> Multiplicar(MatrizTDA <Integer>matriz1,MatrizTDA <Integer>matriz2,int tam,int i,int j)
	{
		MatrizTDA <Integer> resultado=new Matriz<Integer>();
		if(tam<2)
		{
			return (multimplicacion(matriz1,matriz2));//para cuando son de tamaño 2
		}
		else
		{
	...
	private static MatrizTDA <Integer> combinar(MatrizTDA <Integer>m1,MatrizTDA <Integer>m2,MatrizTDA <Integer>m3,MatrizTDA <Integer>m4,int tam)
	{
		MatrizTDA <Integer> auxM1=new Matriz<Integer>();
		auxM1.inicializarMatriz(tam);
		for(int i=0;i<tam;i++)
