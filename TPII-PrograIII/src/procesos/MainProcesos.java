...
public class MainProcesos {
	...
	public static void main(String[] args) {
		...
		/*
		 * try { System.out.println("El beneficio maximo es: "
		 * +resultado.recuperarElemento(0)+"\n"); System.out.println(
		 * "El mejor orden para atender los procesos es: "); for(int
		 * i=1;i<beneficio.capacidadVector()+1;i++)
		 * System.out.println(resultado.recuperarElemento(i)+" "); } catch
